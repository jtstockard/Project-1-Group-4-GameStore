...
public class GamesControllerTest {
    ...
    public void createGame() throws Exception{
        ...
        inputGames.setTitle("Fallout");
        inputGames.setEsrbRating("M");
        inputGames.setDescription("Explore an apocalypse wasteland");
        inputGames.setPrice(new BigDecimal("99.99"));
        inputGames.setStudio("Bethesda");
        inputGames.setQuantity(420);

        String inputJson = mapper.writeValueAsString(inputGames);

        Games outputGames = new Games();
        outputGames.setTitle("Fallout");
        outputGames.setEsrbRating("M");
        outputGames.setDescription("Explore an apocalypse wasteland");
        outputGames.setPrice(new BigDecimal("99.99"));
        outputGames.setStudio("Bethesda");
        outputGames.setQuantity(420);
        outputGames.setId(2);

        String outputJson = mapper.writeValueAsString(outputGames);
